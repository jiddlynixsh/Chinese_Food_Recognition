if __name__ == '__main__':
    ...
    net = Network(
        ...
        dropout_rate=0.5,
        base_learning_rate=0.0005, decay_rate=0.99)
    net.define_inputs(
    ...
    try:
        # 这里的 3 代表 "Dumplings" (假设它是第4个类别)
        target_image_path = './my_dataset/dumplings/000231.jpg' 
        net.run_gradcam(target_image_path, label_idx=3, save_name='gradcam_result.png')
    except Exception as e:
        print("跳过 Grad-CAM，原因:", e)
        print("请在 main.py 中设置正确的 target_image_path 图片路径以生成可视化图。")
